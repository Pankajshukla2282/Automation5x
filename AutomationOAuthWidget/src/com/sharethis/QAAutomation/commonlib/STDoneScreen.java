...
public class STDoneScreen {
    ...
    public String stVerifySharedToText (String service, int expVal, String flow)
    {
		...
		String fbShareMessage="Your message was successfully shared to";
		String twitterShareMessage="Your message was successfully shared to";
		//String linkedinShareMessage="Shared to: LinkedIn";
		String linkedinShareMessage="Your message was successfully shared to";
